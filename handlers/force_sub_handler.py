    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me. Contact my [Support Channel](https://t.me/KS_Team_Live).",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Something went Wrong. Contact my [Support Channel](https://t.me/KS_Team_Live).",
            disable_web_page_preview=True
        )
        return 200
    return 200
